...
/**
 * Official platform logo glyphs (path data from Simple Icons, the standard
 * brand-icon set — lucide carries no brand marks). Rendered with
 * `fill="currentColor"` so they stay monochrome by default and take the
 * platform's official brand color only on hover (via the card's CSS
 * variable), per the design system's color budget.
 */
...
function GeeksforGeeksIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
